...
import com.atul.fampay.contextualcards.views.viewholders.CardGroupViewHolder

/**
 * An adapter that binds the [CardGroup]s data to render on the screen
 * A point to note is that for each [CardGroup], a separate and
 * independent [RecyclerView] is being created
 */
class CardGroupsAdapter(private val context: Context) :
    ...
    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): CardGroupViewHolder {
        cardGroupBinding = LayoutCardGroupBinding
