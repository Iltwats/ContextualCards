package com.atul.fampay.contextualcards.viewmodels

import android.util.Log
import androidx.lifecycle.MutableLiveData
import androidx.lifecycle.ViewModel
import com.atul.fampay.contextualcards.MyApplication.Companion.getContext
import com.atul.fampay.contextualcards.R
import com.atul.fampay.contextualcards.models.CardGroup
import com.atul.fampay.contextualcards.models.CardGroupObject
import com.atul.fampay.contextualcards.networking.Repository
...
class CardGroupViewModel : ViewModel() {
    ...
    /**
     * Stores `status`, of how the communication with the server is going on
     *  It is set to true on 200 OK response,
    ...
    /**
     * A list of [CardGroup] to store and map the data received in the JSON form,
